  ...
  describe "Commands" do
    ...
    describe "task" do
      ...
      it "should create a new task" do
        ...
        state.current_category.tasks.current.description.should eq('Task')
      ...
      it "should switched a new task if task created" do
        ...
        state = app.instance_variable_get(:@state)
        state.current_category.tasks.current.description.should eq('NewTask')
      ...
      it "should edit task" do
        ...
        app = create(['t', '--edit'])
        state = app.instance_variable_get(:@state)
        state.current_category.tasks.current.description.should eq("Edit")
      end
      ...
      it "should marked task" do
        ...
        app = create(['t', '--done'])
        state = app.instance_variable_get(:@state)
        state.current_category.tasks.current.done?().should eq(true)
      end
